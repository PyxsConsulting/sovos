*
*
*CLASS lhc_sovos_inventorylog DEFINITION INHERITING FROM cl_abap_behavior_handler.
*  PRIVATE SECTION.
*
*    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
*      IMPORTING keys REQUEST requested_authorizations FOR /pyxs/sovos_inventorylog RESULT result.
*
*    METHODS create FOR MODIFY
*      IMPORTING entities FOR CREATE /pyxs/sovos_inventorylog.
*
*    METHODS update FOR MODIFY
*      IMPORTING entities FOR UPDATE /pyxs/sovos_inventorylog.
*
*    METHODS delete FOR MODIFY
*      IMPORTING keys FOR DELETE /pyxs/sovos_inventorylog.
*
*    METHODS read FOR READ
*      IMPORTING keys FOR READ /pyxs/sovos_inventorylog RESULT result.
*
*    METHODS lock FOR LOCK
*      IMPORTING keys FOR LOCK /pyxs/sovos_inventorylog.
*
*    METHODS sendintegration FOR MODIFY
*      IMPORTING keys FOR ACTION /pyxs/sovos_inventorylog~sendintegration RESULT res.
*
*ENDCLASS.
*
*
*CLASS lcl_process DEFINITION FRIENDS lhc_sovos_inventorylog.
*  PUBLIC SECTION.
*    CLASS-METHODS: main,
*      build_cnpj
*        IMPORTING
...
*ENDCLASS.
*
*CLASS lhc_sovos_inventorylog IMPLEMENTATION.
*
...
*      APPEND INITIAL LINE TO /pyxs/bp_sovos_inventory_bkp=>lt_log ASSIGNING FIELD-SYMBOL(<log>).
...
*                ).
*
*    res = VALUE #( FOR log IN /pyxs/bp_sovos_inventory_bkp=>lt_log (
*        %cid =  key-%cid
...
*ENDCLASS.
*
*CLASS lsc_sovos_inventorylog DEFINITION INHERITING FROM cl_abap_behavior_saver.
*  PROTECTED SECTION.
*
...
*ENDCLASS.
*
*CLASS lsc_sovos_inventorylog IMPLEMENTATION.
*
*  METHOD finalize.
*  ENDMETHOD.
*
...
*    @/pyxs/bp_sovos_inventory_bkp=>lt_log.
*    CLEAR /pyxs/bp_sovos_inventory_bkp=>lt_log.
*
*
*  ENDMETHOD.
*
...
*        APPEND INITIAL LINE TO /pyxs/bp_sovos_inventory_bkp=>lt_log ASSIGNING <log>.
*        <log>-timedate = time.
...
*      ls_objeto-knwh010-dt_inventario   = lv_now.
...
*      ls_objeto-knw0190-dt_inicial     = lv_now.
*      ls_objeto-knw0190-dt_importacao  = lv_now.
*      ls_objeto-knw0190-ds_unidade     = 'UN'.
*      ls_objeto-knw0190-ds_descricao   = ls_data-unitofmeasuretext-unitofmeasurename.
*
*      " ─── KNW0200 ───
*      ls_objeto-knw0200-cod_empresa     = CONV i( s_branch_sov-sov_company ).
*      ls_objeto-knw0200-cod_filial      = CONV i( s_branch_sov-sov_branch ).
*      ls_objeto-knw0200-dt_inicial      = lv_dt_ini.
...
*           unitofmeasuretext~* AS unitofmeasuretext,
*           productplantbasic~* AS productplantbasic,
*           productvaluationbasic~* AS productvaluationbasic,
...
*      APPEND VALUE #( sign = 'I' option = 'EQ' low = ls_product-stock-material ) TO lr_products.
*    ENDLOOP.
*
