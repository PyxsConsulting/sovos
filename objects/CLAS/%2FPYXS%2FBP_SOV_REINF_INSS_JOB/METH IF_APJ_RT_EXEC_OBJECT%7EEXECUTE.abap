    METHOD if_apj_rt_exec_object~execute.
      ...
      DATA: lt_sendintegration TYPE TABLE FOR ACTION IMPORT /pyxs/sov_reinf_inss~SendIntegration.

      TRY.
          go_log = cl_bali_log=>create_with_header(
            cl_bali_header_setter=>create(
              object    = '/PYXS/SOVOS_TAX_FISC'
              subobject = '/PYXS/SOVOS_REINSS' ) ).
      ...
      MODIFY ENTITIES OF /pyxs/sov_reinf_inss
        ENTITY /pyxs/sov_reinf_inss
      ...
      LOOP AT lt_reported-/pyxs/sov_reinf_inss INTO DATA(ls_reported).
        create_message_log(
          severity = if_bali_constants=>c_severity_default
