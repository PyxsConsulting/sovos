    METHOD if_apj_rt_exec_object~execute.
      ...
      DATA: lt_sendintegration TYPE TABLE FOR ACTION IMPORT /PYXS/ReinfLog~SendIntegration.

      TRY.
          go_log = cl_bali_log=>create_with_header(
            cl_bali_header_setter=>create(
              object    = '/PYXS/SOVOS_TAX_FISC'
              subobject = '/PYXS/SOVOS_REINF' ) ).
      ...
      LOOP AT it_parameters INTO DATA(ls_parameter).
        ...
        CASE ls_parameter-selname.
          ...
          WHEN 'COMPANY'.
            <fs_sendintegration>-%param-ComapnyCode = ls_parameter-low.

          WHEN 'BRANCH'.
            <fs_sendintegration>-%param-BusinessPlace = ls_parameter-low.

          WHEN 'ANOMES'.
            <fs_sendintegration>-%param-AnoMes = ls_parameter-low.

          WHEN 'PARTNER'.
            <fs_sendintegration>-%param-Partner = ls_parameter-low.

        ENDCASE.
      ENDLOOP.

      MODIFY ENTITIES OF /PYXS/ReinfLog
        ENTITY /PYXS/ReinfLog
      ...
      LOOP AT lt_reported-/PYXS/ReinfLog INTO DATA(ls_reported).
        create_message_log(
          severity = if_bali_constants=>c_severity_default
