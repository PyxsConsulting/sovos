    METHOD if_apj_rt_exec_object~execute.
      ...
      DATA: lt_sendintegration TYPE TABLE FOR ACTION IMPORT /pyxs/sovos_year_inventory~sendintegration.

      TRY.
          go_log = cl_bali_log=>create_with_header(
            cl_bali_header_setter=>create(
              object    = '/PYXS/SOVOS_TAX_FISC'
              subobject = '/PYXS/SOVOS_YRINV' ) ).
      ...
      LOOP AT it_parameters INTO DATA(ls_parameter).
        ...
        CASE ls_parameter-selname.
          ...
          WHEN 'MATERIAL'.
            <fs_sendintegration>-%param-Material = ls_parameter-low.
      ...
      MODIFY ENTITIES OF /pyxs/sovos_year_inventory
        ENTITY /pyxs/sovos_year_inventory
      ...
      LOOP AT lt_result INTO DATA(ls_result).
        create_message_log(
          ...
          text     = CONV #( |Execução concluída para o Material { ls_result-%param-Material } Ano/Mes { ls_result-%param-Anomes }| ) ).
      ENDLOOP.

      LOOP AT lt_reported-/pyxs/sovos_year_inventory INTO DATA(ls_reported).
        create_message_log(
          severity = if_bali_constants=>c_severity_default
